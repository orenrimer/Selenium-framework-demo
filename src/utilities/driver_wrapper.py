...
from src.utilities.custom_logger import custom_logger
...
class CustomDriver:
    ...
    def take_screenshot(self, name=""):
        ...
        screenshots_path = join(DIRS['TEST'], "resources", "screenshots", file_name)
        try:
            self.driver.save_screenshot(screenshots_path)
            self.logger.info(f"Saved screenshot in path:: {screenshots_path}")
        except Exception as e:
